  ...
  return (
    <div className="px-4 py-2 flex flex-col lg:flex-1 h-[400px] lg:h-auto overflow-hidden">
      ...
      <div className="mt-4 overflow-y-scroll scrollbar-hide flex-1" ref={scrolLRef} >
        {cartData.length === 0 ? (
          <p className="text-[#ababab] text-sm flex justify-center items-center h-full min-h-[300px]">Su carrito está vacío. ¡Comience a agregar artículos!</p>
        ) : cartData.map((item) => {
          return (
            <div className="bg-[#1f1f1f] rounded-lg px-4 py-4 mb-2">
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <p className="text-[#f5f5f5] text-md font-bold">Bs {item.price}</p>
              </div>
            </div>
          );
        })}
